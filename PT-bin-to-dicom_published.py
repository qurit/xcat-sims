...
Please use the following reference if you publish results obtained using this software:
    ...
    R. Fedrigo, et al., 
    "Development of the Lymphatic System in the 4D XCAT Phantom: Application to Non-Hodgkin's Lymphoma"
...
mydirectory = "C:/Users/Roberto/Documents/Qurit Lab/Lymphoma/XCAT/dicom-conversion/"
mynewfolder = "snm1_R1"
...
################################################
full_file = "runs/"+myfilename
out_dir = mydirectory + mynewfolder
